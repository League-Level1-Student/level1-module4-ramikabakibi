...
//ATTENTION ATTENTION ATTENTION, I'm so close to finishing it, but for some reason the score and tries is not
//going up so we need to fix it. Just run the code and see what's wrong and ask Daniel
